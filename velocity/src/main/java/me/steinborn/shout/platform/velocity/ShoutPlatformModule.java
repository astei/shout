...
public class ShoutPlatformModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        bind(new TypeLiteral<ShoutPlatform<Player>>() {}).toProvider(VelocityShoutPlatformProvider.class);
    ...
    @Singleton
    private static class VelocityShoutPlatformProvider extends ExactlyOnceProvider<ShoutPlatform<Player>> {
